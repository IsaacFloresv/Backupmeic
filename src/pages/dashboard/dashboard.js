...
function Dashboard() {
  ...
  useEffect(() => {
    buscarReportes();
  }, [filtroNReport, filtroAgent, filtroFchCreado, filtroStatus, filtroOrigen, filtroUsuario_s, filtroUs_obser, filtroTdia, filtroNdia, filtroNomba, filtroApell1a, filtroApell2a, filtroEmail, filtroEmail2]);
